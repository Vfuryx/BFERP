    ...
    delMore: function delMore() {
      ...
      if (this.delArr.length === 0) {
        ...
        this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
          ...
          _this6.$del(_this6.goodsUrl, { ids: _this6.delArr }).then(function () {
            _this6.$message({
              message: '删除成功',
              type: 'success'
            });

        ...
        switch ($this->method()) {
            ...
            case 'POST':
                return [
                    ...
                    'jd_specs_code' => 'required|string|max:255',
                    'vips_specs_code' => 'required|string|max:255',
            ...
            case 'PATCH':
                return [
                    ...
                    'spec_code' =>  [
                        'string','max:255',
                        Rule::unique('product_specs')->ignore($this->productspec->id),
                    ],
                    ...
                    'purchase_days_warning' => 'numeric',
                    'available_warning' => 'numeric',
                    'distribution_method_id' => [
                        'integer',
                        Rule::exists('distribution_methods','id')->where(function ($query) {
                            $query->where('status',1);

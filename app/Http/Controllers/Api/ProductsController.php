...
class ProductsController extends Controller
{
    ...
    * 获取所有产品
    *
    * @Get("/products/search{?commodity_code}")
    * @Versions({"v1"})
    * @Parameters({
   ...
   public function searchProducts(SearchProductRequest $request)
   {
     ...
     *      @Parameter("productspecs[0][component_code]", description="子件编码", required=true),
     *      @Parameter("productspecs[0][jd_component_code]", description="京东子件编码", required=false),
     *      @Parameter("productspecs[0][vips_component_code]", description="唯品会子件编码", required=false),
     ...
     *      @Parameter("productspecs[0][is_common]", type="boolean", description="是否通用子件", required=true),
     ...
     *      @Parameter("productspecs[0][component_code]", description="子件编码", required=false),
     *      @Parameter("productspecs[0][jd_component_code]", description="京东子件编码", required=false),
     *      @Parameter("productspecs[0][vips_component_code]", description="唯品会子件编码", required=false),
     ...
     *      @Parameter("productspecs[0][discount]", type="numeric", description="折扣", required=false),
     *      @Parameter("productspecs[0][commission]", type="numeric", description="佣金点", required=false),
     *      @Parameter("productspecs[0][is_common]", type="boolean", description="是否通用子件", required=false),
     *      @Parameter("productspecs[0][package_quantity]", type="integer", description="包件数量", required=false),
     *      @Parameter("productspecs[0][package_costs]", type="numeric", description="打包费用", required=false),
     *      @Parameter("productspecs[0][wooden_frame_costs]", type="numeric", description="木架费", required=false),
     *      @Parameter("productspecs[0][purchase_freight]", type="numeric", description="采购运费", required=false),

...
class LogisticsAreasController extends Controller
{
    ...
    protected const TRANSFORMER = LogisticsAreaTransformer::class;
    protected const MODEL = LogisticsArea::class;
     ...
     * })
     */
    public function destroybyIds(LogisticsAreaRequest $request)
    {
     ...
     * })
     */
    public function editStatusByIds(LogisticsAreaRequest $request)
    {
